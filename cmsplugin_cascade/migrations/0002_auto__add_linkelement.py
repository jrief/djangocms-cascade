...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkElement'
        db.create_table(u'cmsplugin_cascade_linkelement', (
            ...
            ('page_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('text_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('cmsplugin_cascade', ['LinkElement'])


    def backwards(self, orm):
        # Deleting model 'LinkElement'
        db.delete_table(u'cmsplugin_cascade_linkelement')
    ...
    models = {
        ...
        'cmsplugin_cascade.linkelement': {
            'Meta': {'object_name': 'LinkElement'},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['cms.CMSPlugin']"}),
            'context': ('jsonfield.fields.JSONField', [], {'default': '{}', 'null': 'True', 'blank': 'True'}),
            'page_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'text_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'sites.site': {
