...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SharableCascadeElement.glossary'
        db.alter_column(u'cmsplugin_cascade_sharableelement', 'glossary', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'CascadeElement.glossary'
        db.alter_column(u'cmsplugin_cascade_element', 'glossary', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'SharableCascadeElement.glossary'
        db.alter_column(u'cmsplugin_cascade_sharableelement', 'glossary', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'CascadeElement.glossary'
        db.alter_column(u'cmsplugin_cascade_element', 'glossary', self.gf('jsonfield.fields.JSONField')(null=True))
