django.jQuery(function($) {
	...
	// create class handling the client-side part of NavbarPlugin
	var base_plugins = eval(django.cascade.ring_plugin_bases.NavbarPlugin),
	...
	django.cascade.NavbarPlugin = ring.create(base_plugins, {
